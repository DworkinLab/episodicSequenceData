...
episodic_filtered <- initialize_SNP_time_series(chr = episodic_freq$chr, pos=episodic_freq$pos, base.freq = episodic_freq$basePops, lib.freqs = episodic_freq[,7:ncol(episodic_freq), with=FALSE], pop.ident = c(1,2,2,1,1,2,1,2,1,2,1,2,1) , pop.generation = c(115,115,115,115,38,38,38,38,77,77,77,77,0), use.libs = rep(TRUE,13))
